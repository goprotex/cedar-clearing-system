...
export const DEFAULT_RATE_CARD: RateCard = {
  ...
  methodConfigs: [
    { id: 'fine_mulch', label: 'Fine Mulch (Premium)', rateMultiplier: 1.4, timeMultiplier: 1.6, equipment: 'Barko mulcher, multi-pass', result: 'Park-like finish, stumps flush' },
    { id: 'rough_mulch', label: 'Rough Mulch (Standard)', rateMultiplier: 1.0, timeMultiplier: 1.0, equipment: 'Barko mulcher, single pass', result: 'Functional, some stumps' },
    { id: 'chainsaw_pile', label: 'Chainsaw + Grapple Pile', rateMultiplier: 0.75, timeMultiplier: 1.3, equipment: 'Chainsaws, grapple truck', result: 'Cut and stacked, stumps remain' },
    { id: 'chainsaw_haul', label: 'Chainsaw + Haul Off', rateMultiplier: 1.15, timeMultiplier: 1.5, equipment: 'Chainsaws, grapple truck, dump trailer', result: 'Debris removed, stumps remain' },
    ...
    { id: 'selective_thin', label: 'Selective Thin', rateMultiplier: 1.3, timeMultiplier: 1.8, equipment: 'Barko mulcher + chainsaws', result: 'Precision, keep desirable trees' },
    { id: 'cedar_only', label: 'Cedar Only, Protect Oaks', rateMultiplier: 1.15, timeMultiplier: 1.3, equipment: 'Barko mulcher + chainsaws', result: 'Most common Hill Country request' },
    { id: 'row_fence_line', label: 'Right of Way / Fence Line', rateMultiplier: 1.1, timeMultiplier: 1.0, equipment: 'Barko mulcher', result: 'Linear corridor' },
  ],
  disposalAdders: {
    mulch_in_place: 0,
    pile_and_burn: 25,
...
export function getBillableAcreage(
  ...
  const estimatedCedarAcres = cedarAcresOverride ?? pasture.cedarAnalysis?.summary.estimatedCedarAcres ?? pasture.acreage;
...
export function calculatePastureCost(
  ...
  const { billableAcres } = getBillableAcreage(pasture, cedarAcresOverride);
