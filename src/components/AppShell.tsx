...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-[100dvh] min-h-screen bg-[#131313] text-[#e5e2e1] scan-line overflow-x-hidden">
      ...
      <main className="min-w-0 md:ml-64 md:w-[calc(100%-16rem)] overflow-x-hidden pt-[calc(5rem+env(safe-area-inset-top,0px))] px-4 sm:px-6 pb-[max(1.5rem,env(safe-area-inset-bottom,0px))] min-h-[100dvh] min-h-screen">
        {children}
      </main>
    </div>
  );
