  ...
  return (
    <div className="h-screen flex flex-col bg-[#131313] text-[#e5e2e1]">
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden min-h-0">
        {/* Map — min-h-0 + min-w-0 so flex/grid does not collapse the GL canvas; min height on small screens */}
        <div className="h-[40vh] min-h-[220px] md:h-full md:min-h-0 md:flex-1 relative min-w-0 shrink-0 overflow-hidden">
          {mapboxToken ? (
        ...
        {/* Right sidebar */}
        <div className="w-full md:w-[400px] min-h-0 bg-[#131313] border-t-2 md:border-t-0 md:border-l-2 border-[#353534] flex flex-col shrink-0 overflow-hidden flex-1 md:flex-none">
